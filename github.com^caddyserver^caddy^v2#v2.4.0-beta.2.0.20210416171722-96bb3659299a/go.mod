module github.com/caddyserver/caddy/v2-v2.4.0-beta.2.0.20210416171722-96bb3659299a

go 1.17

require github.com/caddyserver/caddy/v2 v2.4.0-beta.2.0.20210416171722-96bb3659299a
